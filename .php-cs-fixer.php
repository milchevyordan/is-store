...
$header = <<<EOF
        ...
        (c) Company | Georgi Ivanov <joroz95@gmail.com>

        Copyright 2000-{$year}, GWEBSOLUTIONS Ltd
        All rights reserved.
    EOF;
...
$rules = [
    ...
    'no_leading_import_slash'            => false, // Remove leading slashes in `use` clauses.
    ...
    'escape_implicit_backslashes' => false, // Escape implicit backslashes in strings and heredocs to ease the understanding of which are special chars interpreted by PHP and which not.
